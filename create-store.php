...
<head>
    ...
    <title>Register Store | xPay </title>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" id="name" placeholder="Store Name"
                                                        class="form-control" required="required" title="Store Name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" id="email"
                                                        placeholder="Store Email" class="form-control"
                                                        required="required" title="Store Email">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="address" name="address" id="address"
                                                        placeholder="Store address" class="form-control"
                                                        required="required" title="Store address">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
